...
(function() {
  var handleRequest, optionsHandler, original;

  original = jQuery.ajax;

  jQuery.extend(jQuery, {
    originalAjax: original,
    resources: Resourcy.resources,
    resource: Resourcy.resource,
    routes: Resourcy.routes
  });
  ...
  optionsHandler = function(opts1, opts2, defaults) {
    var c1, c2, method, options, _i, _len, _ref;
    if (defaults == null) {
      defaults = {};
    }
    options = jQuery.extend(true, {}, opts1, opts2, defaults);
    _ref = ['beforeSend', 'error', 'dataFilter', 'success', 'complete'];
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      if (opts1[method] && opts2[method]) {
        ...
        options[method] = function() {
          ...
          return c2.apply(window, arguments);
        };
      }
    }
    return options;
